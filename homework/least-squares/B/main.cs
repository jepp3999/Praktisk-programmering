...
class main{
    public static void Main(){
        ...
        var A = ls.A;
        matrix cov = ls.Cov(A);
        Write("This is the covariant matrix\n" );
        cov.print();
        double dc = Sqrt(cov[1,1]);
        Write($"The error of lambda is {dc}, such that lambda is given as {-c[1]} +/- {dc}.\n");
        Write($"This in turn gives a half-life of {T} +/- {dc*T} days.\n");
        Write("Thus, the modern value is not within the uncertainty.");
    } 
}